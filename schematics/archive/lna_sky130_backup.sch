...
C {devices/ind.sym} 300 0 1 0 {name=Lg value=2n m=1}
...
C {devices/res.sym} 540 30 0 0 {name=Rload value=50 m=1}
...
C {devices/code_shown.sym} 100 -300 0 0 {name=s1 only_toplevel=false value="
